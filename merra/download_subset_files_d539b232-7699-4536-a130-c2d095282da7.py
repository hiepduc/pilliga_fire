...
To run the script: `python download_subset_files_d539b232-7699-4536-a130-c2d095282da7.py`
...
def main(job_id="d539b232-7699-4536-a130-c2d095282da7"):
    ...
    print(f"\nFinished downloading files! You can find them under the /d539b232-7699-4536-a130-c2d095282da7 directory")
