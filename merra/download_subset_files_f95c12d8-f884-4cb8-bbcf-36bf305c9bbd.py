...
To run the script: `python download_subset_files_f95c12d8-f884-4cb8-bbcf-36bf305c9bbd.py`
...
def main(job_id="f95c12d8-f884-4cb8-bbcf-36bf305c9bbd"):
    ...
    print(f"\nFinished downloading files! You can find them under the /f95c12d8-f884-4cb8-bbcf-36bf305c9bbd directory")
